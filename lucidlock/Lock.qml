...
Scope {
    ...
    PanelWindow {
        ...
        // without this the layer-shell surface never actually receives
        // keyboard events at all, regardless of what QML focus looks like -
        // that's why the password field couldn't be typed into
        ...
        MultiEffect {
            ...
            blurEnabled: true
            // ceiling scales with the >blur slider instead of the fixed 64px -
            // the appear/collapse animations below still drive "blur" itself
            // (0 -> 1) for the lock/unlock choreography, this just caps how
            // strong that reveal is allowed to get, so the slider at 0 keeps
            // the wallpaper crisp even mid-animation
            blurMax: 64 * Theme.blurAmount
            blur: 0
        }
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            onTextChanged: passwordBar.wrong = false
                        }
                ...
                Column {
                    ...
                    Item {
                        ...
                        ListView {
                            ...
                            clip: true
                            spacing: 6
                            model: lockNotifications.notifs
