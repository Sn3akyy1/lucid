...
Item {
    ...
    readonly property int cornerRadius: (root.expanded || root.showingNotify) ? 20 : 60
    ...
    readonly property bool showingNotify: firingReminder !== null
    ...
    readonly property int compactWidth: hasUpcomingReminder ? 168 : 150
    ...
    implicitWidth: showingNotify ? 270 : (expanded ? 300 : compactWidth)
    implicitHeight: showingNotify ? 78 : (expanded ? 480 : 35)
    ...
    Timer {
        ...
        repeat: true
        onTriggered: {
            clockHourText.text = new Date().toLocaleTimeString(Qt.locale(), "hh AP").replace(/\s*[AP]M/i, "");
            clockMinuteText.text = new Date().toLocaleTimeString(Qt.locale(), "mm AP");
            dateText.text = new Date().toLocaleDateString(Qt.locale(), "ddd d");
            expandedTimeText.text = new Date().toLocaleTimeString(Qt.locale(), "h:mm:ss AP");
    ...
    Rectangle {
        ...
        anchors.fill: parent
        color: Theme.bg
        radius: (root.expanded || root.showingNotify) ? 20 : 60
        clip: true
        ...
        Item {
            ...
            opacity: (root.expanded || root.showingNotify) ? 0 : 1
            scale: root.expanded ? 0.82 : 1
            ...
            Row {
                ...
                Row {
                    ...
                    Text {
                        ...
                        text: new Date().toLocaleTimeString(Qt.locale(), "hh AP").replace(/\s*[AP]M/i, "")
                        color: Theme.text
                    ...
                    Text {
                        ...
                        text: new Date().toLocaleTimeString(Qt.locale(), "mm AP")
                        color: Theme.text
                        font.family: Theme.fontFamily
                        font.bold: true
                        font.pixelSize: 13
        ...
        Item {
            ...
            Column {
                ...
                // weather: secondary tonal container
                Rectangle {
                    id: weatherCard
