...
Item {
    ...
    implicitWidth: expanded ? 320 : (compactRow.implicitWidth + horizontalPadding * 3)
    implicitHeight: expanded ? Math.max(120, listCol.implicitHeight + 190) : 35
    clip: true
    ...
    Rectangle {
        ...
        Item {
            ...
            width: compactRow.implicitWidth + (root.horizontalPadding * 3)
            height: 35
            anchors.left: parent.left
            anchors.top: parent.top
            ...
            Row {
                ...
                Text {
                    visible: root.wifiConnected || root.ethernetConnected
